...
forwards = forwards[:len(lefts)][:len(rights)][:len(slows)]
...
final_data = forwards + lefts + rights+ slows
...
np.save('final_training_data_with4.npy', final_data)
